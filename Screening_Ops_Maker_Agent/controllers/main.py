...
@screeningagent.get("/screening-ops-agent/api/get-response/{log_id}")
...
@screeningagent.post("/screening-ops-agent/api/v1/graph-chat-completions")
...
@screeningagent.post("/screening-ops-agent/api/v2/chat-completions")
