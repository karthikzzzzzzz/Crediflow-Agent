...
@reportagent.get("/report-generation-agent/api/get-response/{log_id}")
...
@reportagent.post("/report-generation-agent/api/v1/chat-completions")
...
@reportagent.post("/report-generation-agent/api/v2/chat-completions")
